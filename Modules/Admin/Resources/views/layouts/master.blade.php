...
<head>
    ...
    <!-- Theme style -->
    @if (app()->getLocale() == 'ar')
        <link rel="stylesheet" href="{{ asset('dist/ar/dist/css/adminlte.min.css') }}">
        <!-- Bootstrap 4 RTL -->
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        {{-- start of side bar --}}
        @include('admin::layouts.mainside')
        {{-- end of side bar --}}
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.delete').click(function(e) {
                ...
                e.preventDefault();
                var n = new Noty({
                    text: "@lang('admin::site.confirm_delete')",
                    type: "warning",
                    killer: true,
                    buttons: [
                        ...
                        Noty.button("@lang('admin::site.no')", 'btn btn-primary mr-2', function() {
                            n.close();
                        })
                    ]
                });
